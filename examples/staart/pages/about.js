...
export default withPage(() => (
  <Layout title="About Staart" page="about">
      <div className="container">
        ...
        <p>Staart is <b>not a framework</b>. Staart should introduce the least amount of technology coupling possible. Pick and choose the peaces you like and glue them together as you wish. There might be utilities that do the coupling for you, but it should be straightforward to replace them with something else. You should stay in control.</p>
        ...
        <image src="/static/nickredmark.jpg" style={{
          maxWidth: '100%',
          width: '200px'
        }}/>
      </div>
